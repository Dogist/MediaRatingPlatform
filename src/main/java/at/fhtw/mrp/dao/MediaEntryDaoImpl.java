...
public class MediaEntryDaoImpl implements MediaEntryDao {
    ...
    private MediaEntryEntity parseResultSet(ResultSet rs) throws SQLException {
        List<RatingEntity> ratings = ratingDao.getRatingsForMediaEntry(rs.getLong("media_entry_id"));
        Double averageRating = null;
        try {
            averageRating = ratings.stream().mapToInt(RatingEntity::getRating).average().orElseThrow();
